...
\begin{figure}[h]
	...
	\caption{Przyk³adowy schemat multiprocesora strumieniowego. \cite{czyn_cuda}}
...
\begin{figure}[h]
	...
	\caption{Schemat pamiêci. \cite{czyn_cuda}}
	\label{fig:pamiec}
\end{figure}
...
\begin{figure}[h]
	\centering
		\includegraphics[width=0.5\textwidth]{roz4/img/cuda_blocks.png}
	\caption{Przyk³adowy schemat pokazuj¹cy u³o¿enie w¹tków CUDA w blokach oraz w ca³ej kracie \cite{rt_rollins}}
